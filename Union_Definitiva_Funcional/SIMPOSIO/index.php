                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="stats-card">
                                        <i class="fas fa-pen-fancy fa-3x colorazul mb-3"></i>
                                ...
                                <div class="col-md-6">
                                    <div class="stats-card">
                                        <i class="fas fa-users fa-3x colorazul mb-3"></i>
...
<footer class="colorazul text-white mt-5 py-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-4 mb-md-0">
                <h5 class="mb-3"><i class="fas fa-address-card me-2"></i>Contacto</h5>
