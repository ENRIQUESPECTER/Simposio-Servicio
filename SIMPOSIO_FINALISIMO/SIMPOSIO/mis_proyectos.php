...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['accion_patrocinio'])) {
    ...
    $stmt = $conexion->prepare("
        SELECT p.id_patrocinio, p.id_articulo, a.id_usuario as autor_id
        FROM patrocinios p
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content" style="border-radius: 20px; overflow: hidden;">
                <div class="modal-header" style="background: linear-gradient(135deg, #28a745, #1e7e34); color: white;">
                    <h5 class="modal-title">
                        <i class="fas fa-hand-holding-heart me-2"></i>
                        Patrocinadores del Proyecto: <span id="modalDetalleTitulo"></span>
                    </h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body" id="modalPatrocinadoresDetalleContent">
