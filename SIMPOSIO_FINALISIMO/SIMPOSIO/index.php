...
$sql = "SELECT a.id_articulo, a.titulo, a.tipo_trabajo, a.categoria,
    ...
    FROM articulo a WHERE a.estado = 'aprobado' ORDER BY a.fecha_registro DESC LIMIT 3";
...
// Eventos próximos
$eventos_proximos = [];
$sql_eventos = "SELECT id_evento, titulo, fecha, hora_inicio, hora_fin FROM evento WHERE fecha >= CURDATE() ORDER BY fecha ASC LIMIT 3";
...
<div class="container mt-4">
                        ...
                        <div class="col-md-12 text-center">
                            <?php if (es_empresa()): ?>
                                <a href="patrocinar_proyectos.php" class="btn colordorado text-white btn-lg me-2">
                                    <i class="fas fa-hand-holding-usd me-2"></i>Explorar Proyectos
                                </a>
                                <a href="patrocinar_proyectos.php?ver=solicitudes" class="btn btn-primary btn-lg">
                                    <i class="fas fa-clock me-2"></i>Mis Solicitudes de Patrocinio
                                </a>
                            <?php else: ?>
    ...
    <?php else: ?>
        <div class="alert alert-info mt-3">
            ...
            Por favor, <a href="login.php" class="alert-link">inicie sesión</a> para ver su información personalizada.
        </div>
    <?php endif; ?>
                ...
                <div class="col-md-4">
                    <div class="card h-100">
                        <?php if (!empty($proy['imagen_principal'])): ?>
                            <img src="uploads/proyectos/<?php echo $proy['imagen_principal']; ?>" class="card-img-top" style="height: 200px; object-fit: cover;">
                        <?php else: ?>
...
<footer class="colorazul text-white mt-5 py-5">
    <div class="container">
        ...
        <div class="text-center">
            <p class="mb-0 text-white-50"><i class="far fa-copyright me-2"></i><?php echo date('Y'); ?> Congreso Internacional de Matemáticas.</p>
        </div>
    </div>
</footer>
