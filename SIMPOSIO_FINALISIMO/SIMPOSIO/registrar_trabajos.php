    ...
    if (empty($errores)) {
        ...
        if (empty($errores)) {
            ...
            try {
                ...
                notificar_trabajo_registrado($conexion, $id_articulo, $id_usuario_autor);

                // Notificar a los coautores (si los hay) que se ha registrado un nuevo trabajo
                if (!empty($coautores_internos)) {
                    foreach ($coautores_internos as $id_coautor) {
                        notificar_trabajo_registrado($conexion, $id_articulo, $id_coautor, 'coautor');
                    }
                }                                       
