    ...
    if ($_POST['accion'] == 'actualizar_proyecto') {
        ...
        if (empty($errores)) {
            ...
            try {
                ...
                $conexion->commit();
                // Notificar a los demás participantes que el proyecto fue editado
                notificar_edicion_proyecto($conexion, $id_proyecto, $_SESSION['id_usuario'], "Se actualizó la información general");
