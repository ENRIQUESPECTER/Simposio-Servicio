 ...
 */
function obtener_horarios_disponibles($conexion, $id_evento, $duracion_minutos) {
    ...
    // Obtener todas las actividades ya ocupadas en ese evento
    $ocupados = [];
    ...
    // Generar bloques de 30 minutos (o el mínimo común)
    $disponibles = [];
    ...
    while ($hora_actual + $duracion_minutos * 60 <= $hora_fin_evento) {
        ...
        // Verificar si el bloque se traslapa con alguna actividad ocupada
        $ocupado = false;
        ...
        // Avanzar al siguiente bloque (por ejemplo, 30 minutos)
