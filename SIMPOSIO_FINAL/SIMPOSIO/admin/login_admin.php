        ...
        <div class="navbar-brand container-fluid">
            ...
            <div class="navbar-collapse collapse" id="navbarResponsive">
                <ul class="navbar-nav nav nav-container menu">
                    <li class="nav-item"><a class="nav-link" href="index.php">Panel admin</a></li>
    ...
    <div class="container-login justify-content-center">
        <div class="login-card">
            ...
            <form method="post">
                ...
                <button type="button" class="login-btn"><a href="registro.html" style="text-decoration: none; color: rgb(0, 221, 255);">Registrarse</a></button>
            </form>
        </div>
    </div>
</body>
