                        ...
                        <div class="col-md-4 col-lg-3 mb-3">
                            <div class="card border-success h-100 text-center">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-title mb-1"><?php echo htmlspecialchars($patro['nombre_empresa']); ?></h6>
                                    <small class="text-muted">
                                        <?php echo htmlspecialchars($patro['nombre'] . ' ' . $patro['apellidos']); ?>
                                    </small>
                                    <div class="mt-2">
                                        <i class="fas fa-envelope text-success me-1"></i>
                                        <small><?php echo htmlspecialchars($patro['correo']); ?></small>
                                    </div>
                                </div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <?php else: ?>
                        ...
                        <div class="d-flex gap-2">
                            <a href="simposio.php" class="btn-volver">
